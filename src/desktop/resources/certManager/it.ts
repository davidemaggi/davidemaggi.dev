...
const itCertFolders: CertificateFolder[] = [
  {
    id: 'personal',
    label: 'Personale',
    certificates: [
      {
        ...
        description: 'Certificato TLS usato per il sito personale e API pubbliche.',
      },
      {
  ...
  {
    id: 'trusted-roots',
    label: 'Autorita radice attendibili',
    certificates: [
      {
        id: 'isrg-root-x1',
        ...
        description: 'CA root usata per la catena Lets Encrypt.',
      },
      {
